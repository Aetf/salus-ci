...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Person, last_updated_),
  ~0u,  // no _has_bits_
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AddressBook_default_instance_);_Person_default_instance_._instance.get_mutable()->last_updated_ = const_cast< ::google::protobuf::Timestamp*>(
...
// .google.protobuf.Timestamp last_updated = 5;
bool Person::has_last_updated() const {
...
const ::google::protobuf::Timestamp& Person::last_updated() const {
...
::google::protobuf::Timestamp* Person::mutable_last_updated() {
...
::google::protobuf::Timestamp* Person::release_last_updated() {
...
void Person::set_allocated_last_updated(::google::protobuf::Timestamp* last_updated) {
  delete last_updated_;
